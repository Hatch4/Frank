...
const turtleExhaustedImg = new Image();
turtleExhaustedImg.src = "turtle_exhausted.png";

// === SOUNDS (WAV for iOS + Android compatibility) ===
...
function update() {
    ...
    if (!turtle.exhausted) {
        ...
        if (turtle.collapseAngle < Math.PI / 1.3) {
...
function draw() {
    ...
    // Turtle (with collapse animation)
    ctx.save();
